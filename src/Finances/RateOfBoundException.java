...
public class RateOfBoundException extends RuntimeException {
    ...
    public RateOfBoundException(Object obj){
        this.obj = obj;
    }

    public RateOfBoundException(String message) {
        super(message);
        throwedClass = this.getStackTrace()[1].getClassName();
        fileName = this.getStackTrace()[1].getFileName();
        methodName = this.getStackTrace()[1].getMethodName();
